...
ScrollReveal().reveal('.about .description, .contact-right', {delay: 200 , origin:'right', interval:200});
ScrollReveal().reveal('.about .professional-list li', {delay: 200 , origin:'right', interval:200});
ScrollReveal().reveal('.skills-description , .services-description, .contact-card, .client-slider, .contact-left h2', {delay: 200 , origin:'left'});
ScrollReveal().reveal('.experience-card , .service-card ,.education, .portfolio .img-card', {delay: 200 , origin:'bottom', interval:200});
